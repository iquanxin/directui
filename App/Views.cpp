      ...
      "<HorizontalLayout>"
        "<VerticalLayout width=\"150\" >"
          ...
          "<NavigatorPanel>"
            ...
            "<NavigatorButton name=\"page_configure\" text=\"<i 4> Opsxning\" />"
        ...
        "<VerticalLayout>"
          ...
          "<WindowCanvas watermark=\"StartWatermark\" >"
            "<VerticalLayout>"
              "<TextPanel text=\"<f 8>Vxg startomrxe?</h>\" />"
              "<FadedLine />"
              "<TileLayout scrollbar=\"true\" >"
                "<TextPanel name=\"link_registers\" text=\"<i 7 50><a><f 6>&Registre</f></a>\n<h>\n<c #444540>Vxg denne menu for at rette i diverse registre i systemet.\n\nDu kan rette i kunde, vogn og chauffx-reigsteret.\" shortcut=\"R\" />"
                "<TextPanel name=\"link_systems\" text=\"<i 9 50><a><f 6>&Systemer</f></a>\n<h>\n<c #444540>Gennem denne menu kan du opsxte diverse ting.\" shortcut=\"S\" />"
                "<TextPanel name=\"link_configure\" text=\"<i 6 50><a><f 6>Opsxning</f></a>\n<h>\n<c #444540>Opsxning giver adgang til konfiguration af de mange kxsels-systemer og regler.\" />"
      ...
      "<HorizontalLayout>"
        "<VerticalLayout width=\"150\" >"
          ...
          "<NavigatorPanel>"
            ...
            "<NavigatorButton name=\"page_registers\" text=\"<i 4> Registre\" tooltip=\"Vis forskellige registre\" />"
            "<NavigatorButton name=\"page_systems\" text=\"<i 4> Systemer\" />"
            "<NavigatorButton name=\"page_configure\" text=\"<i 4> Opsxning\" selected=\"true\" />"
            "<NavigatorButton name=\"page_reports\" text=\"<i 4> Rapporter\" />"
          "</NavigatorPanel>"
        "</VerticalLayout>"
        "<VerticalLayout>"
          "<Toolbar>"
            "<LabelPanel align=\"right\" text=\"<f 6><c #fffe28>System Opsxning</c></f>\" />"
          "</Toolbar>"
          "<ToolbarTitlePanel name=\"titlepanel\" text=\"<f 7>System Opsxning</f>\" />"
          "<TitleShadow />"
          "<WindowCanvas>"
            "<VerticalLayout>"
              ...
              "<HorizontalLayout>"
                ...
                "<VerticalLayout>"
                  "<TextPanel text=\"<f 6><c #2c4378>Opsxningsliste</c></f>\" />"
                  "<SeparatorLine />"
                  "<TextPanel text=\"<c #414141>Dobbeltklik pet element i listen for at konfigurere det.</c>\n\" />"
                  "<List header=\"hidden\" >"
                     ...
                     "<ListLabelElement text=\"<i 4> Chauffx register\" />"
      ...
      "<HorizontalLayout>"
        ...
        "<VerticalLayout>"
          ...
          "<WindowCanvas>"
            "<VerticalLayout>"
              "<DialogLayout scrollbar=\"true\" >"
                "<LabelPanel pos=\"0, 0, 80, 24\" text=\"<b>&Sxefter</b>\" stretch=\"group\" />"
                "<SingleLineEdit pos=\"80, 2, 220, 22\" name=\"navn\" stretch=\"size_x\" />"
                "<Button pos=\"224, 2, 265, 22\" text=\"Sx\" name=\"ok\" stretch=\"move_x\" />"
        ...
        "<VerticalLayout>"
          ...
          "<WindowCanvas>"
            "<TileLayout>"
               ...
               "<TextPanel text=\"<i 2 50><a><f 6>Chauffx Rapporter</f></a>\n<h>\n<c #444540>Rapporter for chauffxer registeret.\" />"
...
{ 
   return "<Dialog caption=\"Search Page\" >"
      "<VerticalLayout>"
        "<ToolbarTitlePanel text=\"<f 6>Sx efter en vej.</f><p><x 10>Indtast sxekriterier og sx efter vejen.\" />"
        "<DialogCanvas>"
          "<VerticalLayout>"
            "<DialogLayout>"
              ...
              "</DropDown>"
              "<LabelPanel pos=\"0, 36, 60, 60\" text=\"Sx\" stretch=\"group\" />"
              "<SingleLineEdit pos=\"60, 38, 250, 58\" name=\"search\" text=\"\" stretch=\"size_x\" />"
              "<Button pos=\"260, 38, 340, 58\" name=\"ok\" text=\"&Sx\" stretch=\"move_x\" />"
            ...
            "<TabFolder>"
               "<TabPage text=\"Generelt\" >"
                  "<DialogLayout scrollbar=\"true\" >"
                    ...
                    "<SingleLinePick pos=\"110, 62, 240, 82\" text=\"<i 3><a>Bjarke Viksx</a>\" stretch=\"size_x\" />"
                    ...
                    "<SingleLinePick pos=\"110, 132, 240, 152\" text=\"<a>Nxrebred, Vallensbx</a>\" stretch=\"size_x\" />"
                    "<LabelPanel pos=\"260, 130, 370, 154\" text=\"Note\" stretch=\"move_x\" />"
                    "<MultiLineEdit pos=\"370, 132, 510, 192\" text=\"Dette er en meget lang note omkring denne person. Her fxger noget mere tekst\" stretch=\"move_x size_x\" />"
                    ...
                    "<DropDown pos=\"110, 162, 240, 182\" stretch=\"move_x size_x\">"
                       ...
                       "<ListLabelElement text=\"2625 Vallensbx\" />"
                    "</DropDown>"

                    "<Option pos=\"0, 192, 120, 212\" text=\"Husnr krxet\" selected=\"true\" />"
                    "<Option pos=\"120, 192, 240, 212\" text=\"Ikke krxet\" />"
                  "</DialogLayout>"
               "</TabPage>"
...
{ 
   return "<Dialog>"
      "<VerticalLayout>"
        ...
        "<DialogCanvas>"
          "<VerticalLayout>"
            "<TextPanel text=\"Det er ikke altid godt at trykke p?linket. Du kan fortryde dit klik ved at vxge Nej knappen.\" />"
            "<PaddingPanel />"
            "<DialogLayout>"
              "<PaddingPanel pos=\"0, 0, 340, 4\" />"
              "<SeparatorLine  pos=\"0, 4, 340, 18\" stretch=\"group size_x\" />"
